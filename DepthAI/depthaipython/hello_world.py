...
# Next, we link the camera 'isp' output to the neural network detection input, so that it can produce detections
cam_rgb.isp.link(detection_nn.input)
