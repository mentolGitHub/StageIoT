...
#define ITSDK_LORAWAN_DEVEUI		{0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x89, 0x8C}									   // Static DEVEUI (big endian)
																		   // Bytes are in the same order as
																		   // in a String.

#define ITSDK_LORAWAN_APPEUI		{0x15, 0x98, 0x75, 0x32, 0x15, 0x98, 0x75, 0x32}									   // Static APPEUI (big endian)
																		   // Bytes are in the same order as
																		   // in a String.

#define ITSDK_LORAWAN_APPKEY		{0x66, 0x8C, 0xF3, 0xDE, 0x48, 0xDC, 0x29, 0xA6, 0x96, 0x1D, 0x77, 0x9A, 0x8A, 0x4A, 0x54, 0x70}									   // Static APPKEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.


#define ITSDK_LORAWAN_NWKKEY		{0x66, 0x8C, 0xF3, 0xDE, 0x48, 0xDC, 0x29, 0xA6, 0x96, 0x1D, 0x77, 0x9A, 0x8A, 0x4A, 0x54, 0x70}									   // Static NETWORK KEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.
...
#define ITSDK_LORAWAN_NWKSKEY		{													\
										0xB4, 0x2B, 0x73, 0x5C, 0x0C, 0x31, 0xA0, 0x2D, 0x2C, 0xEF, 0x9A, 0xD0, 0x89, 0x9A, 0xCB, 0xA6 \
									}									   // Static NETWORK SESSION ENCRYPT KEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.
#define ITSDK_LORAWAN_APPSKEY		{													\
										0xCA, 0x6B, 0x26, 0x44, 0x31, 0xA7, 0xFF, 0x88, 0x15, 0x67, 0x09, 0xD8, 0x1A, 0xB1, 0x29, 0x50 \
