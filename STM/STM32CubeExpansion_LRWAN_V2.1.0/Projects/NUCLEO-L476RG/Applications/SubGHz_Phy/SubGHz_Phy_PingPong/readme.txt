...
@par Directory contents
  ...
  - SubGHz_Phy_PingPong/Core/Inc/stm32l4xx_hal_conf.h                           HAL configuration file.
  - SubGHz_Phy_PingPong/Core/Inc/stm32l4xx_it.h                                 This file contains the headers of the interrupt handlers.
  ...
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/nucleo_l476rg_bus.h                   header file for the BSP BUS IO driver
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/nucleo_l476rg_errno.h                 Error Code
  ...
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1261dvk1bas_conf.h                  Pin mapping sx126x-evb_e407 shield (daughter board)
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1262dvk1cas_conf.h                  Pin mapping sx126x-evb_e407 shield (daughter board)
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1262dvk1das_conf.h                  Pin mapping sx126x-evb_e407 shield (daughter board)
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1272mb2das_conf.h                   This file provides code for the configuration
                                                                                of the shield instances (pin mapping).
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1276mb1las_conf.h                   This file provides code for the configuration
                                                                                of the shield instances (pin mapping).
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/sx1276mb1mas_conf.h                   This file provides code for the configuration
                                                                                of the shield instances (pin mapping).
  ...
  - SubGHz_Phy_PingPong/Core/Src/stm32l4xx_hal_msp.c                            This file provides code for the MSP Initialization
                                                                                and de-Initialization codes.
  - SubGHz_Phy_PingPong/Core/Src/stm32l4xx_it.c                                 Interrupt Service Routines.
  - SubGHz_Phy_PingPong/Core/Src/stm32_lpm_if.c                                 Low layer function to enter/exit low power modes (stop, sleep)
  - SubGHz_Phy_PingPong/Core/Src/system_stm32l4xx.c                             CMSIS Cortex-M4 Device Peripheral Access Layer System Source File
  ...
  - SubGHz_Phy_PingPong/SubGHz_Phy/Target/nucleo_l476rg_bus.c                   source file for the BSP BUS IO driver
